...
module.exports = [
{
  ...
  intro: "Indianapolis calls itself the Crossroads of America for a reason: I-65, I-69, I-70, and I-74 all meet there, which makes Indiana one of the easiest states in the country to move out of on a consolidated load. In Indiana we benefit from that density — trucks pass through constantly, so shared-load departures are frequent and transit windows short. Most long-distance moves from Indiana head south to Florida, Texas, and the Carolinas.",
...
},
{
  ...
  intro: "Iowa sits at the crossing of I-80 and I-35, which means cross-country trucks pass through the Des Moines area constantly and consolidated space out of the state is easy to find. In Iowa we work a market defined by insurance and agribusiness employment in Des Moines, university cycles in Iowa City and Ames, and a large share of moves involving rural properties with long gravel drives. Long-distance loads from Iowa run heavily to Texas, Arizona, and Colorado.",
...
},
{
  ...
  intro: "Kansas splits into two distinct moving markets: the Johnson County suburbs of Kansas City — Overland Park, Olathe, Lenexa — which behave like a major metro, and everything west of Topeka, which is long-distance rural. In Kansas we mostly run I-70 east–west and I-35 southwest toward Oklahoma and Texas. Aviation employment in Wichita and Fort Riley's military rotations at Manhattan generate a steady flow of relocations with fixed dates.",
...
},
{
  ...
  faqs: [
    { q: "When should I schedule a Kentucky move?", a: "October is the state's best moving month — mild weather and good availability. May through August is the busiest window, with a Lexington spike around University of Kentucky turnover. Kentucky's characteristic winter hazard is freezing rain rather than snow accumulation, and it closes the interstates for a day at a time a few times each winter, so January and February delivery windows carry a contingency day. Whatever your date, call us before you assume it is too late — we run last-minute long-distance moves every week and will tell you straight away whether we can take yours." },
...
},
{
  ...
  intro: "Maryland's moving market is really three markets: the Baltimore rowhouse belt, the Montgomery County federal-employment corridor along I-270, and the Eastern Shore. In Maryland we deal with rowhouse stairs and no off-street parking in Baltimore, security-clearance and agency relocation timelines in Bethesda and Silver Spring, and Bay Bridge constraints for anything crossing to the Shore. Outbound long-distance volume runs heavily to Florida and the Carolinas.",
...
},
{
  ...
  intro: "Boston has the most concentrated moving day in America: September 1, when a huge share of the region's leases turn over at once. In Massachusetts we plan our entire year around it. Beyond that, the market is defined by triple-decker walk-ups, colonial-era street grids where a 53-foot trailer cannot turn, and city permit requirements for reserving curb space. Long-distance volume out of Massachusetts runs strongly to Florida, the Carolinas, and Texas.",
...
},
{
  ...
  intro: "Missouri borders eight states and sits at the intersection of I-70, I-44, and I-55, which makes it one of the easiest places in the country to catch a consolidated load going almost anywhere. In Missouri we work two large metros with very different housing stock — St. Louis's brick two-flats and Kansas City's sprawling suburbs — plus the Ozarks, where steep terrain and lake properties routinely require shuttle service.",
  ...
  faqs: [
    { q: "When should I schedule a Missouri move?", a: "October is the best month by weather and availability. May through August is peak, with a Columbia spike in mid-August for the university calendar, and Missouri summers are humid enough to require early starts. Winter is mostly workable though ice storms close I-70 across the middle of the state occasionally. Spring is flood season — the Missouri and Mississippi can close secondary routes and low-water crossings in the Ozarks. Whatever your date, call us before you assume it is too late — we run last-minute long-distance moves every week and will tell you straight away whether we can take yours." },
