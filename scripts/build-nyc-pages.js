...
// Styles only these pages use: the headline tagline, the long-title size and
// the routes section.
...
@media (min-width: 769px) {
  .hero h1 { font-size: clamp(2.8rem, 4.9vw, 3.9rem); }
  .hero-long h1 { font-size: clamp(2.3rem, 3.9vw, 3.3rem); max-width: 19ch; }
}
